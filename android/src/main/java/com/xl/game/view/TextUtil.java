...
public class TextUtil
{
	...
	public static int mFontColor = 0;	// 字体颜色
	...
	public void GetTextIfon()
	{
	  ...
	  * @param canvas
	  */
	public void DrawText(Canvas canvas,int fontsize)
	{
		for (int i = this.mCurrentLine, j = 0; i < this.mRealLine; i++, j++)
		{
			...
			canvas.drawText((String) (mString.elementAt(i)), this.mTextPosx+5,
							this.mTextPosy + fontsize+ this.mFontHeight * j, mPaint);
		}
	}
	 /**
	  * 翻页等按键处理
